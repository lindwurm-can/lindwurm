...
#ifndef UDSTOOLSPLUGIN_H
#define UDSTOOLSPLUGIN_H

#include "udstools_global.h"
#include <pluginsystem/iplugin.h>

namespace Lindwurm::Core
{
    class UDSTOOLS_EXPORT UdsToolsPlugin : public PluginSystem::IPlugin
    {
        Q_OBJECT
